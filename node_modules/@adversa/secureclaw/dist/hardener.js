 ...
 */
export async function harden(options = {}) {
 ...
 */
export async function rollback(stateDir, timestamp) {
    ...
    for (const file of backupFiles) {
        if (file === 'manifest.json')
            continue;
        if (file === 'openclaw.json.original')
            continue;
        if (file === 'openclaw.json')
            continue;
        if (file === 'openclaw-config.json')
            continue; // duplicate
...
//# sourceMappingURL=hardener.js.map