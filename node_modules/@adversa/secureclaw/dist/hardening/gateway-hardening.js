...
export const gatewayHardening = {
    ...
    async fix(ctx, backupDir) {
        ...
        try {
            ...
            else if ((oldPassword ?? config.gateway.auth.token ?? '').length > 0 &&
...
//# sourceMappingURL=gateway-hardening.js.map