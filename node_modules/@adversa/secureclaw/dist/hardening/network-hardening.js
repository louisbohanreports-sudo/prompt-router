...
function generateIptablesScript(allowlist, blocklist) {
    const lines = [
        '#!/bin/bash',
...
function generatePfScript(allowlist, blocklist) {
    const lines = [
    ...
    async fix(ctx, backupDir) {
        ...
        try {
            ...
            try {
                ...
                db = { c2_ips: [], malicious_domains: [], malicious_skill_hashes: {}, typosquat_patterns: [], dangerous_prerequisite_patterns: [], infostealer_artifacts: { macos: [], linux: [] }, version: '0', last_updated: '' };
            }
...
//# sourceMappingURL=network-hardening.js.map