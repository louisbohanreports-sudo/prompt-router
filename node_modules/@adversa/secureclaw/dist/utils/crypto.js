 ...
 */
export function deriveKey(machineId, stateDir, salt) {
 ...
 */
export function encrypt(plaintext, machineId, stateDir) {
 ...
 */
export function decrypt(data, machineId, stateDir) {
 ...
 */
export async function ensureKeystore(stateDir) {
 ...
 */
export async function encryptFile(filePath, machineId, stateDir, backupDir) {
 ...
 */
export async function decryptFile(filePath, machineId, stateDir) {
