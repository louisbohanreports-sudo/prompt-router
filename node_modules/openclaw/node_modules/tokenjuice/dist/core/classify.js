...
import { deriveCommandMatchCandidates } from "./command-match.js";
...
export function matchesRule(ruleLike, input) {
    const rule = getJsonRule(ruleLike);
...
export function findBestRuleMatch(input, rules) {
...
export function resolveRuleMatch(input, rules) {
...
export function classifyExecution(input, rules, forcedRuleId) {
    if (forcedRuleId) {
